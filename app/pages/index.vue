      ...
      <div v-else class="flex gap-5">
        ...
        >
          <template #default="{ item: movie }">
            <NuxtLink :to="`/films/${movie.id}`" class="block w-64 group">
              <NuxtImg :src="movie.cover" class="w-full h-96 object-cover rounded-lg group-hover:shadow-xl group-hover:scale-[1.05] transition-all">
